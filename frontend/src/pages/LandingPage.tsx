                ...
                <section className="relative w-full border-b border-border-dark bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]">
                    ...
                    <div className="relative max-w-[1440px] mx-auto px-6 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="flex flex-col gap-6 max-w-2xl">
                            ...
                            <p className="text-[#ded2ad] text-base sm:text-lg leading-relaxed max-w-lg border-l-2 border-primary pl-4">
                ...
                <div className="max-w-[1440px] mx-auto px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Agents</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Integrations</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Security</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Changelog</a>
                        </div>
                        <div className="flex flex-col gap-4">
                            <h4 className="text-white font-bold text-sm uppercase tracking-wider">Resources</h4>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Documentation</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">API Reference</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Community</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Case Studies</a>
                        </div>
                        <div className="flex flex-col gap-4">
                            <h4 className="text-white font-bold text-sm uppercase tracking-wider">Company</h4>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">About</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Careers</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Legal</a>
                            <a className="text-[#ded2ad] hover:text-primary transition-colors text-sm" href="#">Contact</a>
                        </div>
                    </div>
